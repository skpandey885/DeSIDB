                    ...
                    <div className="-my-8 divide-y-2 divide-gray-100">
                        ...
                        <div className="py-8 flex flex-wrap md:flex-nowrap">
                            <div className="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
                                <span className="font-semibold text-lg title-font text-gray-700">
                                    Organisation
                                </span>
                                <span className="mt-1 text-gray-500 text-sm">AICTE</span>
                                <span className=" mt-4 text-lg	 font-semibold title-font text-gray-700">
                                    Duration
                                </span>
                                <span className="mt-1 text-gray-500 text-sm">Self Paced</span>
                                <span className=" mt-4 text-lg	 font-semibold title-font text-gray-700">
                                    Price
                                </span>
                                <span className="mt-1 text-gray-500 text-md">Free</span>
                            </div>
                            <div className="md:flex-grow">
                                ...
                                Information Gathering plays a significant role in the Cybersecurity domain.
                                 It's one of the five fundamental pillars of the attacking cycle. 
                        ...
                        <div className="py-8 flex flex-wrap md:flex-nowrap">
                            <div className="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
                                ...
                                <span className="mt-1 text-gray-500 text-sm">Free</span>
                            </div>
                            <div className="md:flex-grow">
                                <h2 className="text-2xl font-medium text-gray-900 title-font mb-2">
                                Search Engine Optimization Social Media Optimization Course Paid Marketing (Facebook + Google) Graphic Designing MS Excel
                                </h2>
                                <p className="leading-relaxed">
                        ...
                        <div className="py-8 flex flex-wrap md:flex-nowrap">
                            <div className="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
                                ...
                                <span className="mt-1 text-gray-500 text-sm">Virtual CyberLabs</span>
                                <span className=" mt-4 text-lg	 font-semibold title-font text-gray-700">
                                    Duration
                                </span>
                                <span className="mt-1 text-gray-500 text-sm">Self Paced</span>
                        ...
                        <div className="py-8 flex flex-wrap md:flex-nowrap">
                            <div className="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
                                ...
                                <span className="mt-1 text-gray-500 text-sm">IGNOU</span>
                                <span className=" mt-4 text-lg	 font-semibold title-font text-gray-700">
                                    Duration
                                </span>
                                <span className="mt-1 text-gray-500 text-sm">12 weeks</span>
                                <span className=" mt-4 text-lg	 font-semibold title-font text-gray-700">
                                    Price
                                </span>
                                <span className="mt-1 text-gray-500 text-sm">Free</span>
