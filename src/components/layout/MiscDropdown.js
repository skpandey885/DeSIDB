        ...
        >
          <Menu.Items className="absolute right-0 mt-2 w-56 origin-top-left bg-white ring-1 ring-gray-200 shadow-lg rounded">
            <div className="p-1  flex flex-col i">
              <Menu.Item>
                  <Link className='px-4 py-1 rounded hover:bg-gray-100 duration-100' to='/others/fellowships'>
                    Fellowships
                  </Link>

              </Menu.Item>
              <Menu.Item>
              <Link className='px-4 py-1 rounded hover:bg-gray-100 duration-100' to='/trainings'>
                  Training Programs
                  </Link>
              </Menu.Item>
            </div>
