...
export default function BrowseDropdown() {
  return (
      <Menu as="div" className="relative inline-block text-left">
        <div>
          <Menu.Button className="inline-flex items-center rounded hover:bg-gray-100 px-4 py-2 ">
            Browse
            <ChevronDownIcon
        ...
        >
          <Menu.Items className="absolute right-0 mt-2 w-40 origin-top-left bg-white ring-1 ring-gray-200 shadow-lg rounded">
