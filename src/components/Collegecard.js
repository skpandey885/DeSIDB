    ...
    return (
        <div>
            <div className="p-5  w-[320px] bg-white rounded-lg border shadow-md sm:p-8  ">
                ...
                <a target={"_blank"} rel='noreferrer' href={data?.cid.website} className="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-200  font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center"
                >
                Learn More
                </a>
            </div>
